"""
Minimal working server for the 5-idea dashboard
"""
...
# Test if we can import the LLM agent service
try:
    from app.services.llm_agent_service import llm_agent_service
    LLM_AVAILABLE = True
    print("✅ LLM Agent Service available")
except Exception as e:
    print(f"❌ LLM Agent Service error: {e}")
    LLM_AVAILABLE = False

app = FastAPI(title="AI Business Intelligence - Minimal Dashboard")
...
async def get_dashboard():
    """Get regular dashboard data (redirects to AI-generated)"""
    return await get_ai_dashboard()
